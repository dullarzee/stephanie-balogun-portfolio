                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-white/70 max-w-2xl mx-auto">
                            I craft visual narratives through color, enhancing
                            the emotional impact of every frame. My work spans
                            Films, music videos, and commercials, each with a
                            unique color story.
                        </p>
                    </motion.div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            ...
                            <p className="text-lg">
                                Stephanie Balogun is a Nigerian-based filmmaker
                                who specializes in cinematography and coloring.
                                Scratch that, let me talk about me. I have
                                always had a passion and an interest in visual
                                art. It started with a love for acting and
                                photography, and then it morphed into a love for
                                the art of filmmaking- I no longer wanted to
                                simply be in movies, I wanted to tell stories.
                            </p>
