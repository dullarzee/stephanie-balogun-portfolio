        ...
        <div className="relative min-h-screen">
            ...
            <section className="py-24 px-6 md:px-12 bg-black text-white">
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        <span className="text-orange">Color</span> is my
                        language
                    </motion.h2>
                    ...
                    <motion.p
                        ...
                        transition={{ duration: 0.8, delay: 0.4 }}
                    >
                        I craft visual narratives through color, enhancing the
                        emotional impact of every frame. My work spans Films,
                        music videos, and commercials, each with a unique color
                        story.
                    </motion.p>
                </div>
            </section>
            ...
            <section className="py-24 px-6 md:px-12 bg-gradient-to-b from-beige-lighter to-white">
                <div className="max-w-7xl mx-auto">
                    <motion.div
                        ...
                        transition={{ duration: 0.8 }}
                    >
                        <h2 className="font-serif text-3xl md:text-5xl mb-4 md:mb-0">
                            Selected Work
                        </h2>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            ...
                            <p className="text-lg">
                                I'm a film colorist with over 5 years of
                                experience crafting visual aesthetics for films,
                                commercials, and music videos.
                            </p>
                            <p>
                                My approach to color grading is rooted in
                                storytelling. I believe that color is a powerful
                                tool that can enhance narrative, evoke emotion,
                                and create memorable visual experiences.
                            </p>
                            <p>
                                I've collaborated with directors and
                                cinematographers across various genres, helping
                                them achieve their creative vision through
                                thoughtful color work.
                            </p>
                            <div className="pt-6">
                                <Link
                                    href="/about"
            ...
            <section className="py-24 px-6 md:px-12 bg-gradient-to-r from-orange to-orange-light text-white">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    >
                        ...
                        collaborations. If you'd like to discuss your project or
...
const services = [
    {
        title: "Color Grading",
        description:
            "Professional color grading services for films, commercials, music videos, and other visual content.",
        icon: (
            <svg
    ...
    },
    {
        ...
        description:
            "Pre-production color consultation to help plan your project's visual aesthetic and color palette.",
        icon: (
            <svg
                className="w-6 h-6 text-white"
                fill="none"
    ...
    },
    {
        ...
        description:
            "Custom look development to create unique visual styles that enhance your storytelling.",
        icon: (
            <svg
                className="w-6 h-6 text-white"
                fill="none"
...
function TestimonialsCarousel({ testimonials }: { testimonials: [] }) {
